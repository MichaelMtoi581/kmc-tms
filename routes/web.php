...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('planned-trainings')->name('planned-trainings.')->group(function () {
        ...
        Route::get('department/{department}', [PlannedTrainingController::class, 'department'])->name('department');
    });
    ...
    Route::prefix('unplanned-trainings')->name('unplanned-trainings.')->group(function () {
        ...
        Route::get('department/{department}', [UnplannedTrainingController::class, 'department'])->name('department');
    });
