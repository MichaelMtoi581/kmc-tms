...
@section('title', 'Add Unplanned Training')

@section('plugins.Select2', true)

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-clipboard mr-2"></i>Add Unplanned Training</h1>
        ...
        <div class="col-md-8">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-header">
                    <h3 class="card-title">New Unplanned Training</h3>
                </div>

                <form method="POST" action="{{ route('unplanned-trainings.store') }}">
                    @csrf
