                    ...
                    <div class="card-body">
                        ...
                        @php
                            ...
                            $currentRegType = old('registration_type',
                                $unplannedTraining->staff_id ? 'staff' : 'department'
                            );
                        @endphp
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="start_month" name="start_month" class="form-control">
                                        ...
                                        @foreach(['January','February','March','April','May','June','July','August','September','October','November','December'] as $m)
                                            <option value="{{ $m }}" {{ old('start_month', $unplannedTraining->start_month) === $m ? 'selected' : '' }}>{{ $m }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="start_year" name="start_year" class="form-control">
                                        ...
                                        @foreach(range(2050, date('Y') - 8) as $y)
                                            <option value="{{ $y }}" {{ old('start_year', $unplannedTraining->start_year) == $y ? 'selected' : '' }}>{{ $y }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="end_month" name="end_month" class="form-control">
                                        <option value="">Select Month</option>
                                        @foreach(['January','February','March','April','May','June','July','August','September','October','November','December'] as $m)
                                            <option value="{{ $m }}" {{ old('end_month', $unplannedTraining->end_month) === $m ? 'selected' : '' }}>{{ $m }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="end_year" name="end_year" class="form-control">
                                        <option value="">Select Year</option>
                                        @foreach(range(2050, date('Y') - 8) as $y)
                                            <option value="{{ $y }}" {{ old('end_year', $unplannedTraining->end_year) == $y ? 'selected' : '' }}>{{ $y }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
