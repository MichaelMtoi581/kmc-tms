                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>Period</th>
                            <td>
                                {{ $unplannedTraining->start_period_label ?? $unplannedTraining->start_date?->format('d M Y') ?? '—' }}
                                &mdash;
                                {{ $unplannedTraining->end_period_label ?? $unplannedTraining->end_date?->format('d M Y') ?? '—' }}
                            </td>
                        </tr>
                        <tr>
                            <th>Venue</th>
