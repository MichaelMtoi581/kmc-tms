...
@section('title', 'Import Unplanned Trainings')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-file-import mr-2"></i>Import Unplanned Trainings</h1>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="card card-success card-outline">
                ...
                <form method="POST" action="{{ route('unplanned-trainings.import.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('unplanned-trainings.import.template') }}" class="btn btn-info">
