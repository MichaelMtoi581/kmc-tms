...
@section('title', 'Staff Training Details')

@section('plugins.Datatables', true)

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1><i class="fas fa-user-graduate mr-2"></i>Staff Training Details</h1>
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{ route('reports.index') }}">Reports</a></li>
            <li class="breadcrumb-item"><a href="{{ route('reports.staff') }}">By Staff</a></li>
            <li class="breadcrumb-item active">{{ $staffData->staff->full_name }}</li>
        </ol>
    </div>
@endsection
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ route('reports.export', ['type' => 'staff', 'format' => 'xlsx', 'staff_id' => $staffData->staff->id]) }}" class="btn btn-success btn-sm">
                    <i class="fas fa-file-excel mr-1"></i> Excel
                </a>
                <a href="{{ route('reports.export', ['type' => 'staff', 'format' => 'pdf', 'staff_id' => $staffData->staff->id]) }}" class="btn btn-danger btn-sm">
                    <i class="fas fa-file-pdf mr-1"></i> PDF
                </a>
                <button onclick="window.print()" class="btn btn-default btn-sm"><i class="fas fa-print mr-1"></i> Print</button>
                <a href="{{ route('reports.staff') }}" class="btn btn-secondary btn-sm ml-2">
